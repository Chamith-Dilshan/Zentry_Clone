    ...
    return (
        <div className='relative h-dvh w-screen overflow-x-hidden'>
            ...
            rounded-lg bg-blue-75'>
                <div>
                    {/* BACKGROUND VIDEO - Currently playing video */}
                    <video
                        // src={getVideoSource(currentIndex === totalVideos - 1 ? 1 : currentIndex + 1)}
                    ...
                    {/* MINI VIDEO CONTAINER - Shows preview of next video */}
