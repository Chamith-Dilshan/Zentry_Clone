...
const BentoTilt = ({ children, className = '' }: BentoTiltProps) => {
    ...
    const handelMouseMove = (e: { clientX: number; clientY: number; }) => {
        ...
        <div className='relative size-full'>
            ...
            p-5 text-blue-50'>
                <div>
                    ...
                    {description && (
                        <p className="mt-3 max-w-64 text-xs font-robert-regular md:text-base">{description}</p>
                    )}
                </div>
            </div>
        </div>
                ...
                <div className='grid h-[135vh] w-full grid-cols-2 grid-rows-3 gap-7'>
                    <BentoTilt className='bento-tilt-1 row-span-1 md:col-span-1 md:row-span-2'>
                        <BentoCard
                            ...
                            title={<>zig<b>m</b>a</>}
                            description='An anime and gaming-inspired NFT collection - the 
                        IP primed for expansion.'
                        />
                    </BentoTilt>
