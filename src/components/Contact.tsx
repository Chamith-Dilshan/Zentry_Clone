            ...
            <div className="relative rounded-lg bg-black py-24 text-blue-50 sm:overflow-hidden">
                ...
                overflow-hidden sm:block lg:left-20 lg:w-96">
                    ...
                    <ImageClipBox
                        ...
                        clipClass="contact-clip-path-2 md:translate-y-20 translate-y-60"
                    />
                </div>
                ...
                <div className="flex flex-col items-center text-center">
                    ...
                    <AnimatedTitle
                        ...
                        containerClass="special-font !md:text-[6.2rem] w-full 
                        font-zentry !text-5xl !font-black !leading-[.9]"
                    />
